...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7690846874:AAFOlncSLFmmvyQJNZG5jW57ygPaMOaYTi4")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002385483320"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "jeffy25rf")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://envs.sh/oJx.jpg https://envs.sh/oJ-.jpg https://envs.sh/ooD.jpg")).split() #Required
