...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7378354734:AAEbEpcqT2i9FFHOgvd-fGlBI9zgRFCX2BY")
...
PICS = (os.environ.get("PICS", "https://envs.sh/soS.jpg https://envs.sh/soW.jpg https://envs.sh/soB.jpg https://envs.sh/soI.jpg")).split() #Required
